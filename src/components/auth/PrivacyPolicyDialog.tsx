...
const PRIVACY_POLICY_CONTENT = `# 개인정보처리방침

Carescheduler(이하 '회사'라 함)은 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
...
1. 수집항목
   - 필수항목: 이메일 주소, 이름, 비밀번호, 닉네임, 환자 등록 번호
   - 선택항목: 없음

2. 수집방법
   - 웹사이트 회원가입, 모바일 앱 회원가입, 게시판
...
- 개인정보 보호책임자
  - 성명: 박승현
  - 직책: 대표
  - 연락처: 01083555231, carescheduler7@gmail.com
...
- 개인정보 열람청구 접수·처리 부서
  - 부서명: 고객센터
  - 담당자: 박승현
  - 연락처: 010-8355-5231, carescheduler7@gmail.com
...
이 개인정보처리방침은 2025-11-15부터 적용됩니다.`
