...
const TERMS_CONTENT = `# CareScheduler 서비스 이용약관

## 제1조 (목적)

이 약관은 CareScheduler(이하 "회사"라 함)이 제공하는 서비스의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
