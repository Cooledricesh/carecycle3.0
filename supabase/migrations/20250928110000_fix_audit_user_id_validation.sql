-- ============================================================================
-- Fix Audit Trigger to Handle Invalid User IDs
-- ============================================================================
-- The audit trigger was trying to insert invalid user_id (00000000...)
-- which violates the foreign key constraint to auth.users.
-- This migration ensures user_id is only set if it's valid.
-- ============================================================================
...
COMMENT ON FUNCTION audit_table_changes() IS
    ...
    Fixed to validate user_id before inserting to avoid foreign key constraint violations.
    Sets user_id to NULL if the user does not exist or is invalid.';