-- Migration: Fix audit_table_changes function to use department_id instead of care_type
-- Created: 2025-11-10
-- Purpose: Update audit function that still references deprecated care_type columns
-- Issue: record "old" has no field "care_type" error when updating patients
...
'Audit trigger function updated to use department_id instead of deprecated care_type column. Records PHI/PII-safe changes to patients, profiles, and schedules tables.';
