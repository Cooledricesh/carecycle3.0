-- User Approval System - Comprehensive Security Implementation
...
-- ========================================
-- STEP 1: Update User Registration Function
-- ========================================
...
-- ========================================
-- STEP 2: Create Helper Function for Active User Check
-- ========================================
...
-- ========================================
-- STEP 3: Drop All Insecure "Allow All" Policies
-- ========================================
...
-- ========================================
-- STEP 4: Implement Secure RLS Policies - PROFILES
-- ========================================
...
-- ========================================
-- STEP 5: Implement Secure RLS Policies - PATIENTS
-- ========================================
...
-- ========================================
-- STEP 6: Implement Secure RLS Policies - SCHEDULES
-- ========================================
...
-- ========================================
-- STEP 7: Implement Secure RLS Policies - SCHEDULE EXECUTIONS
-- ========================================
...
-- ========================================
-- STEP 8: Implement Secure RLS Policies - ITEMS
-- ========================================
...
-- ========================================
-- STEP 9: Secure Other Supporting Tables
-- ========================================
...
-- ========================================
-- STEP 10: Create Admin Functions for User Management
-- ========================================
...
-- ========================================
-- STEP 11: Create View for Pending Users (Admin Only)
-- ========================================
...
CREATE POLICY "pending_users_admin_only" ON public.pending_users
FOR SELECT
TO authenticated
USING (public.is_user_admin());

-- ========================================
-- STEP 12: Add Audit Logging for User Management Actions
-- ========================================
...
INSERT INTO public.audit_logs (
    ...
    jsonb_build_object(
        ...
        'migration_version', '20250902100001'
    ),
