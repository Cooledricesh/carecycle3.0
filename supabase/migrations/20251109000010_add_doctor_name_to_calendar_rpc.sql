-- ============================================================================
-- Migration: Add doctor_name to get_calendar_schedules_filtered
-- Created: 2025-11-09
-- Purpose: Fix missing doctor_name in calendar RPC function
-- ============================================================================
...
CREATE FUNCTION "public"."get_calendar_schedules_filtered"(
  ...
  "priority" integer,
  "doctor_id" "uuid",
  "doctor_name" "text",  -- ADDED: Doctor name for UI display
  "care_type" "text",
...
BEGIN
  ...
  SELECT
    ...
    s.priority,
    p.doctor_id,
    pr.name as doctor_name,  -- ADDED: Doctor name from profiles
    d.name as care_type,
  ...
  LEFT JOIN profiles pr ON p.doctor_id = pr.id  -- ADDED: Join profiles for doctor name
...
COMMENT ON FUNCTION "public"."get_calendar_schedules_filtered" IS
  'Calendar schedules with doctor_name included. Updated to use departments table.';
...
-- MIGRATION COMPLETE
-- ============================================================================
-- ✅ doctor_name added to get_calendar_schedules_filtered
-- ✅ profiles table joined for doctor name
