...
## 1. 제품 개요
반복되는 검사·주사 일정을 **손쉽게 등록·추적·체크**할 수 있도록 돕는 **초간단 웹 기반 일정 관리·자동 체크리스트** 툴. 수작업 일정 누락·오류를 제거하고 업무 시간을 절감하는 것이 핵심 목표.
